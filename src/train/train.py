...
ARMS: dict[str, dict] = {
    ...
    # S3.3: B0V3-KD-FEAT + plain 11x11 depthwise block (S3.3 receptive-field CONTROL)
    "S33-K11-CACHED": {"norm": {"arch": "student_v3",
                     "use_dcp_prior": True,
                     "use_strip_pool": True,
                     "use_oriented_streak": True,
                     "use_reparam_oriented": True,
                     "reparam_k": 11,
                     ...
                     "clamp_bound": 8.0,
                     "enc_clamp_stages": [3], "deep_clamp_bound": 32.0},
              "config": "configs/train/s33_k11_cached.yaml",
              "desc": "S3.3 receptive-field control, 11x11 depthwise, CACHED teacher"},
    "S33-CTRL-CACHED": {"norm": {"arch": "student_v3",
                     "use_dcp_prior": True,
                     "use_strip_pool": True,
                     "use_oriented_streak": True,
                     "norm_type": "layernorm2d",
                     ...
                     "clamp_bound": 8.0,
                     "enc_clamp_stages": [3], "deep_clamp_bound": 32.0},
              "config": "configs/train/s33_ctrl_cached.yaml",
              "desc": "S3.3 no-block control, CACHED teacher (pairs with S33-K11-CACHED)"},
    "B0V3-KD-K11": {"norm": {"arch": "student_v3",
                     "use_dcp_prior": True,
                     "use_strip_pool": True,
                     "use_oriented_streak": True,
                     "use_reparam_oriented": True,
                     ...
                     "clamp_bound": 8.0,
                     "enc_clamp_stages": [3], "deep_clamp_bound": 32.0},
              "config": "configs/train/b0v3_kd_k11.yaml",
              "desc": "B0V3-KD-FEAT + plain 11x11 depthwise block (S3.3 receptive-field CONTROL)"},
    # S3.3: B0V3-KD-FEAT + reparameterizable oriented block, decoder stages (S3.3)
    "B0V3-KD-ORI": {"norm": {"arch": "student_v3",
                     "use_dcp_prior": True,
                     "use_strip_pool": True,
                     "use_oriented_streak": True,
                     "use_reparam_oriented": True,
                     "reparam_k": 11,
                     "reparam_variant": "oriented",
                     "reparam_middle": False,
                     "norm_type": "layernorm2d",
                     "full_res_norm_type": "affine_clamp",
                     "clamp_bound": 8.0,
                     "enc_clamp_stages": [3], "deep_clamp_bound": 32.0},
              "config": "configs/train/b0v3_kd_ori.yaml",
              "desc": "B0V3-KD-FEAT + reparameterizable oriented block, decoder stages (S3.3)"},
    # S3.3: B0V3-KD-FEAT + oriented block, decoder + middle (S3.3 placement)
    "B0V3-KD-ORI-MID": {"norm": {"arch": "student_v3",
                     "use_dcp_prior": True,
                     "use_strip_pool": True,
                     "use_oriented_streak": True,
                     "use_reparam_oriented": True,
                     ...
                     "clamp_bound": 8.0,
                     "enc_clamp_stages": [3], "deep_clamp_bound": 32.0},
              "config": "configs/train/b0v3_kd_ori_mid.yaml",
              "desc": "B0V3-KD-FEAT + oriented block, decoder + middle (S3.3 placement)"},
    # S1.1 scaling: w16 DEEPER (blocks doubled), GT-only (14,469,731 params)
    "S11-W16-DEEP": {"norm": {"arch": "student_v3",
                 "width": 16,
                 ...
                 "clamp_bound": 8.0,
                 "enc_clamp_stages": [3], "deep_clamp_bound": 32.0},
              "config": "configs/train/s11_w16_deep.yaml",
              "desc": "S1.1 scaling: w16 DEEPER (blocks doubled), GT-only"},
    # S1.1 scaling: w24, GT-only (16,632,387 params)
    "S11-W24": {"norm": {"arch": "student_v3",
                 "width": 24,
                 ...
                 "clamp_bound": 8.0,
                 "enc_clamp_stages": [3], "deep_clamp_bound": 32.0},
              "config": "configs/train/s11_w24.yaml",
              "desc": "S1.1 scaling: w24, GT-only"},
    # S1.1 scaling: w32, GT-only (29,458,371 params)
    "S11-W32": {"norm": {"arch": "student_v3",
                 "width": 32,
                 "enc_blk_nums": [2, 2, 4, 8],
                 "middle_blk_num": 12,
                 "dec_blk_nums": [2, 2, 2, 2],
                 ...
                 "clamp_bound": 8.0,
                 "enc_clamp_stages": [3], "deep_clamp_bound": 32.0},
              "config": "configs/train/s11_w32.yaml",
    ...
    # Single-task derain, StudentV3 w16, GT-only -- isolates three-task dilution (control: B0V3)
    "DERAIN-ONLY-W16": {"norm": {"arch": "student_v3",
                 "use_dcp_prior": True,
                 "use_strip_pool": True,
                 "use_oriented_streak": True,
                 "norm_type": "layernorm2d",
                 ...
                 "clamp_bound": 8.0,
                 "enc_clamp_stages": [3], "deep_clamp_bound": 32.0},
          "config": "configs/train/derain_only_w16.yaml",
          "desc": "Single-task derain, StudentV3 w16, GT-only -- isolates three-task dilution (control: B0V3)"},
...
ARM_GEOMETRY = {"M-A": W16_SIDD, "M-F": W16_SIDD, "B0": W16_SIDD,
                ...
                "S33-K11-CACHED": W16_SIDD,
                "S33-CTRL-CACHED": W16_SIDD,
                "B0V3-KD-K11": W16_SIDD,
                "B0V3-KD-ORI": W16_SIDD,
                "B0V3-KD-ORI-MID": W16_SIDD,
                "S11-W16-DEEP": W16_SIDD,
                "S11-W24": W16_SIDD,
                "S11-W32": W16_SIDD,
                "B0V3M": W16_SIDD,
                "DERAIN-ONLY-W16": W16_SIDD,
                "B0V3": W16_SIDD,
